      ...
      <div className="flex-auto w-full sm:w-2/3 md:w-3/5 lg:w-2/5 flex flex-col justify-center">
        <div className="w-4/5 mx-auto">
          ...
          <div className="my-10 sm:my-40">
            <h1 className="font-semibold text-3xl">Verifikasi OTP</h1>
            ...
            <button className="rounded-md color-button-verif border-solid border-2 w-full p-4 font-bold text-white">
              Verif
            </button>
          </div>
        </div>
